...
def createParser(iargs = None):
    ...
    parser.add_argument("--burst_id", dest='bid',
                         required=True, type=str, help='burst ID to be processed (e.g., t160_342230_iw2)')
    parser.add_argument("--inputCSLC", dest='inputCSLC',
                         default='cslc', type=str, help='input directory for cslc (default: cslc)')
...
def main(inps):
    ...
    cslc_dir = f'{inputDir}/{burst_id.upper()}/{inputCSLC}'   #location of cslc slv vrt 
    ...
    hdf_dir = f'{inputDir}/{burst_id.upper()}/{out_dir}'    #location of slc hdffiles
